...
<div class="panel">
  ...
  <a href="/addItem">Add Item to Category</a>
  <a href="/RemoveCategory">Remove Category</a>
  <a href="/RemoveItemFromCat">Remove Item</a>
  <a href="/AddAdv">Add advertise</a>
  <a href="/OfferToProfile">Offer To Tourists</a>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse">
				<ul class="nav navbar-nav navbar-left">
					<li><a href="#intro" class="smoothScroll" style = "blue">خانه</a></li>
					<li><a href="#feature" class="smoothScroll">دسته بندی ها</a></li>
					<li><a href="#team" class="smoothScroll">شهرها</a></li>
					<li><a href="#pricing" class="smoothScroll">پیشنهادات</a></li>
					<!--<li><a href="#testimonial" class="smoothScroll"></a></li>-->
