...
<h2 >اضافه نمودن تبلیغات</h2>
</div>

<form  action="{{route('addedAdv')}}" method="post" enctype="multipart/form-data" class="singleCard">
	<h2>فرم ثبت اطلاعات تبلیغات را پر نمایید</h2>
	<h2>اسم تبلیغ</h2>
...
<input type="textarea" name="description" ><br>
  ...
  <input type="submit" value="Submit" style="margin:50px">
